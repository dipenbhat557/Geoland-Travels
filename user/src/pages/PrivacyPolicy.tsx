  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className={`${styles.padding} mt-14`}>
        ...
        <p className="mb-4">
          Our website address is https://geolandtravels.com.
        </p>
        ...
        <p className="mb-4">
          ...
          it. The Gravatar service privacy policy is available{" "}
          <a
        ...
        <h3 className="text-xl font-semibold mb-2">Where we send your data</h3>
        <p className="mb-4">
