                        ...
                        <div className="flex flex-col gap-5.5 p-6.5">
                            ...
                            <div className=''>
                                ...
                                {inputFields.map((inputField, index) => (
                                    <div className="input-container flex py-3" key={index}>

                                        <input
                                            type="text"
                                            placeholder="Itenary Input"
                                            value={inputField.value}
                                            onChange={(e) => handleValueChange(index, e)}
                                            className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                                        />

                                        <button className="delete-btn pl-2" onClick={() => handleRemoveFields(index)}>
                                            <svg
                                        ...
                                        <button onClick={handleAddFields} className=" bg-transparent  text-blue-700 font-semibold hover:text-white py-2 px-1   ">
                                            <svg width="27px" height="64px" viewBox="0 0 24 24" fill="" xmlns="http://www.w3.org/2000/svg" stroke="#808080"><g id="SVGRepo_bgCarrier" stroke-width="2"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12H20M12 4V20" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
